...
![Full Stack Architecture](Docs/architecture_ui_api_pipeline.png)
...
![T⁴ Lattice Mesh — 3D projection of the discrete Calabi–Yau geometry](Docs/fig1_torus3d.png)
...
![Face curvature heatmap showing per-face ‖F_f‖ values](Docs/fig2_heatmap.png)
...
![Wall-crossing sweep showing slope filtration λ₁(t) and λ₂(t)](Docs/fig3_wallcrossing.png)
...
![Dolbeault Laplacian eigenvalue spectrum with zero mode highlighted in yellow](Docs/fig4_spectrum.png)
...
![Numerical pipeline: T⁴ mesh → SU(N) links → holonomies → endomorphism → slopes + spectrum](Docs/fig5_pipeline.png)
...
![3D slope surfaces of the Hermitian endomorphism Φ over the torus](Docs/fig6_slopes3d.png)
